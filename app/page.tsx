...
const messageStyle: React.CSSProperties = { padding: "12px", border: "1px solid #d8c8a3", background: "#ffffff", color: "#111111", borderRadius: "8px" };
...
const dashboardCardStyle: React.CSSProperties = { border: "1px solid #d8c8a3", padding: "20px", background: "#ffffff", color: "#111111", borderRadius: "8px" };
const sectionStyle: React.CSSProperties = { marginTop: "40px", maxWidth: "1000px", background: "#ffffff", color: "#111111" };
const panelStyle: React.CSSProperties = { marginTop: "16px", padding: "16px", border: "1px solid #d8c8a3", background: "#ffffff", borderRadius: "8px" };
const emptyStateStyle: React.CSSProperties = { padding: "16px", border: "1px dashed #999", background: "#ffffff", borderRadius: "8px" };
const labelStyle: React.CSSProperties = { display: "block", marginTop: "12px", color: "#111111", fontWeight: 600 };
const inputStyle: React.CSSProperties = { display: "block", width: "100%", padding: "8px", marginTop: "4px", background: "#ffffff", color: "#111111", border: "1px solid #d8c8a3", borderRadius: "8px" };
...
const detailCardStyle: React.CSSProperties = { marginTop: "16px", padding: "16px", border: "1px solid #d8c8a3", background: "#ffffff", color: "#111111", borderRadius: "8px" };
const detailGridStyle: React.CSSProperties = { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "16px" };
const noteCardStyle: React.CSSProperties = { padding: "12px", border: "1px solid #d8c8a3", background: "#ffffff", borderRadius: "8px" };
const activityCardStyle: React.CSSProperties = { padding: "12px", border: "1px solid #d8c8a3", background: "#ffffff", borderRadius: "8px" };
const activityDetailsStyle: React.CSSProperties = { marginTop: "8px", padding: "10px", background: "#ffffff", border: "1px solid #ddd", fontSize: "13px", display: "grid", gap: "6px", borderRadius: "8px" };
...
const fileCardStyle: React.CSSProperties = { border: "1px solid #d8c8a3", padding: "10px", background: "#ffffff", color: "#111111", borderRadius: "8px" };
const thumbnailStyle: React.CSSProperties = { width: "100%", height: "140px", objectFit: "cover", border: "1px solid #ccc", marginBottom: "8px", background: "#ffffff", borderRadius: "8px" };
const filePlaceholderStyle: React.CSSProperties = { height: "140px", border: "1px solid #ccc", marginBottom: "8px", display: "flex", alignItems: "center", justifyContent: "center", background: "#ffffff", textAlign: "center", padding: "8px", color: "#111111", borderRadius: "8px" };
const gateBadgeStyle: React.CSSProperties = { display: "inline-flex", alignItems: "center", gap: "8px", padding: "4px 10px", borderRadius: "999px", background: "#ffffff", border: "1px solid #d8c8a3", whiteSpace: "normal" };
